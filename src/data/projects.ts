...
export const projects: Project[] = [
  {
    ...
    description: 'Современный сайт отеля с системой бронирования',
  ...
  },
  {
    ...
    description: 'Дизайнерский сайт магазина премиального белья',
    category: 'E-commerce',
    link: 'https://нюкта.рф',
  ...
  },
  {
    id: 3,
    title: '«Даймонд»',
    description: 'Сайт-визитка клининг компании',
  ...
  },
  {
    ...
    description: 'Современный сайт гостивого дома с системой бронироования',
    category: 'Гостиничный бизнес',
