...
const steps = [
  ...
  { num: '03', title: 'Разработка', text: 'Пишем чистый код. Адаптивная вёрстка, SEO, интеграции и CMS.' },
  { num: '04', title: 'Запуск', text: 'Тестирование, деплой и передача проекта. Поддержка после запуска.' },
];
